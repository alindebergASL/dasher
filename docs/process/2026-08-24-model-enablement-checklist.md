...
| --- | -------------------------------------------------------------------------------------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ |
| 1   | The web app imports neither `@dasher/planner/anthropic` nor `@anthropic-ai/sdk`                          | **holds**          | `apps/web/no-model-calls.test.ts`                                                                                                          |
...
| 7   | Spend budget     | **absent**                     | Matches for "budget" refer to ledger finance data, revision, complexity, or byte limits and to gate prose. No provider-spend accounting or enforcement exists.                                                              |
